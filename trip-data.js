      ...
      systems: [
        {
          ...
          stations: [
            { label: "I-485", name: "I-485 / South Boulevard Station", query: "I-485 South Boulevard Station Charlotte NC", lat: 35.107222, lon: -80.882778 },
            { label: "Sharon Rd W", name: "Sharon Road West Station", query: "Sharon Road West Station Charlotte NC", lat: 35.119444, lon: -80.882083 },
            { label: "Arrowood", name: "Arrowood Station", query: "Arrowood Station Charlotte NC", lat: 35.135556, lon: -80.876389 },
            { label: "Archdale", name: "Archdale Station", query: "Archdale Station Charlotte NC", lat: 35.152778, lon: -80.8775 },
            { label: "Tyvola", name: "Tyvola Station", query: "Tyvola Station Charlotte NC", lat: 35.163056, lon: -80.8775 },
            { label: "Woodlawn", name: "Woodlawn Station", query: "Woodlawn Station Charlotte NC", lat: 35.175833, lon: -80.879167 },
            { label: "Scaleybark", name: "Scaleybark Station", query: "Scaleybark Station Charlotte NC", lat: 35.190833, lon: -80.875 },
            { label: "New Bern", name: "New Bern Station", query: "New Bern Station Charlotte NC", lat: 35.199722, lon: -80.869028 },
            { label: "East/West", name: "East / West Boulevard Station", query: "East West Boulevard Station Charlotte NC", lat: 35.211944, lon: -80.859167 },
            { label: "Bland St", name: "Bland Street Station", query: "Bland Street Station Charlotte NC", lat: 35.215833, lon: -80.855278 },
            { label: "Carson", name: "Carson Station", query: "Carson Station Charlotte NC", lat: 35.218889, lon: -80.850833 },
            { label: "Brooklyn Village", name: "Brooklyn Village Station", query: "Brooklyn Village Station Charlotte NC", lat: 35.221389, lon: -80.846944 },
            { label: "3rd St", name: "3rd Street / Convention Center Station", query: "3rd Street Convention Center Station Charlotte NC", lat: 35.223611, lon: -80.843056 },
            { label: "CTC/Arena", name: "Charlotte Transportation Center / Arena Station", query: "CTC Arena Station Charlotte NC", lat: 35.225, lon: -80.841389 },
            { label: "7th St", name: "7th Street Station", query: "7th Street Station Charlotte NC", lat: 35.227222, lon: -80.838056 },
            { label: "9th St", name: "9th Street Station", query: "9th Street Station Charlotte NC", lat: 35.2297, lon: -80.835 },
            { label: "Parkwood", name: "Parkwood Station", query: "Parkwood Station Charlotte NC", lat: 35.236306, lon: -80.82355 },
            { label: "25th St", name: "25th Street Station", query: "25th Street Station Charlotte NC", lat: 35.2417, lon: -80.8171 },
            { label: "36th St", name: "36th Street Station", query: "36th Street Station Charlotte NC", lat: 35.248489, lon: -80.807589 },
            { label: "Sugar Creek", name: "Sugar Creek Station", query: "Sugar Creek Station Charlotte NC", lat: 35.251792, lon: -80.794225 },
            { label: "Old Concord Rd", name: "Old Concord Road Station", query: "Old Concord Road Station Charlotte NC", lat: 35.260314, lon: -80.776497 },
            { label: "Tom Hunter", name: "Tom Hunter Station", query: "Tom Hunter Station Charlotte NC", lat: 35.277264, lon: -80.767622 },
            { label: "University City Blvd", name: "University City Boulevard Station", query: "University City Boulevard Station Charlotte NC", lat: 35.286783, lon: -80.761261 },
            { label: "McCullough", name: "McCullough Station", query: "McCullough Station Charlotte NC", lat: 35.300747, lon: -80.753256 },
            { label: "JW Clay", name: "JW Clay Boulevard / UNC Charlotte Station", query: "JW Clay Boulevard UNC Charlotte Station Charlotte NC", lat: 35.310556, lon: -80.745278 },
            { label: "UNC Main", name: "UNC Charlotte Main Station", query: "UNC Charlotte Main Station Charlotte NC", lat: 35.312222, lon: -80.733611 }
          ]
        },
        {
          id: "clt-gold",
          ...
          stations: [
            { label: "French St", name: "French Street Stop", query: "French Street CityLYNX Gold Line Charlotte NC", lat: 35.24601, lon: -80.85688 },
            { label: "JCSU", name: "Johnson C. Smith University Stop", query: "Johnson C Smith University Gold Line Charlotte NC", lat: 35.243, lon: -80.85839 },
            { label: "Bruns Ave", name: "Bruns Avenue Stop", query: "Bruns Avenue Gold Line Charlotte NC", lat: 35.24, lon: -80.85846 },
            { label: "Wesley Heights", name: "Wesley Heights Stop", query: "Wesley Heights Gold Line Charlotte NC", lat: 35.23732, lon: -80.85879 },
            { label: "Irwin Ave", name: "Irwin Avenue Stop", query: "Irwin Avenue Gold Line Charlotte NC", lat: 35.235, lon: -80.85277 },
            { label: "Johnson & Wales", name: "Johnson & Wales University Stop", query: "Johnson and Wales University Gold Line Charlotte NC", lat: 35.23346, lon: -80.85059 },
            { label: "Gateway", name: "Charlotte Gateway Station Stop", query: "Charlotte Gateway Station Gold Line Charlotte NC", lat: 35.23136, lon: -80.84807 },
            { label: "Mint St", name: "Mint Street Stop", query: "Mint Street Gold Line Charlotte NC", lat: 35.22967, lon: -80.84593 },
            { label: "Tryon St", name: "Tryon Street Stop", query: "Tryon Street Gold Line Charlotte NC", lat: 35.22742, lon: -80.84334 },
            { label: "CTC/Arena", name: "CTC / Arena Stop", query: "CTC Arena Gold Line Charlotte NC", lat: 35.225, lon: -80.841389 },
            { label: "Davidson St", name: "Davidson Street Stop", query: "Davidson Street Gold Line Charlotte NC", lat: 35.222688, lon: -80.837801 },
            { label: "McDowell St", name: "McDowell Street Stop", query: "McDowell Street Gold Line Charlotte NC", lat: 35.221042, lon: -80.83593 },
            { label: "CPCC", name: "Central Piedmont Community College Stop", query: "CPCC Gold Line Charlotte NC", lat: 35.217667, lon: -80.831473 },
            { label: "Elizabeth & Hawthorne", name: "Elizabeth & Hawthorne Stop", query: "Elizabeth Hawthorne Gold Line Charlotte NC", lat: 35.213611, lon: -80.826389 },
            { label: "Hawthorne & 5th", name: "Hawthorne & 5th Street Stop", query: "Hawthorne 5th Street Gold Line Charlotte NC", lat: 35.21371, lon: -80.824548 },
            { label: "8th St", name: "8th Street Stop", query: "8th Street Gold Line Charlotte NC", lat: 35.216409, lon: -80.821311 },
            { label: "Sunnyside", name: "Sunnyside Avenue Stop", query: "Sunnyside Avenue Gold Line Charlotte NC", lat: 35.2196, lon: -80.81884 }
          ]
        }
      ],
      bikeStations: [
      ...
      systems: [
        {
          ...
          stations: [
            { label: "Union", name: "Union Station Transit Center", query: "Union Station Transit Center Denver CO", lat: 39.753056, lon: -105 },
            { label: "38th / Blake", name: "38th / Blake Station", query: "38th Blake Station Denver CO", lat: 39.770694, lon: -104.973778 },
            { label: "40th / Colorado", name: "40th / Colorado Station", query: "40th Colorado Station Denver CO", lat: 39.776056, lon: -104.942583 },
            { label: "Central Park", name: "Central Park Station", query: "Central Park Station Denver CO", lat: 39.770361, lon: -104.891639 },
            { label: "Peoria", name: "Peoria Station", query: "Peoria Station Denver CO", lat: 39.767556, lon: -104.850417 },
            { label: "40th & Airport", name: "40th Avenue & Airport Boulevard / Gateway Park Station", query: "40th Avenue Airport Boulevard Gateway Park Station Denver CO", lat: 39.769889, lon: -104.787694 },
            { label: "61st & Peña", name: "61st / Peña Station", query: "61st and Pena Station Denver CO", lat: 39.807028, lon: -104.784 },
            { label: "DEN Airport", name: "Denver Airport Station", query: "Denver Airport Station Denver CO", lat: 39.846111, lon: -104.673889 }
          ]
        }
      ],
      bikeStations: [
